...
<script src="https://code.jquery.com/jquery-3.1.1.min.js" integrity="sha256-hVVnYaiADRTO2PzUGmuLJr8BLUSjGIZsDYGmIJLv2b8=" crossorigin="anonymous"></script>
	...
	<link href="<?php echo e(asset('public/css/bootstrajqueryp.css')); ?>" rel="stylesheet">
	 <link href="<?php echo e(asset('public/css/style.css')); ?>" rel="stylesheet">
	  <link href="<?php echo e(asset('public/css/style2.css')); ?>" rel="stylesheet">
	  <link href="<?php echo e(asset('public/css/slippry.css')); ?>" rel="stylesheet">
	  <link href="<?php echo e(asset('public/css/slider.css')); ?>" rel="stylesheet">
	  <!-- Scripts -->
    <script>
...
<script>
	...
	<script src="<?php echo e(asset('public/js/uikit.js')); ?>"></script>
	<script src="<?php echo e(asset('public/js/slippry.min.js')); ?>"></script>
</body>
</html>
